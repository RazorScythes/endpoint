...
router.post('/toggleBookmark', auth.allowCors(gamePublic.toggleBookmark))
router.post('/getBookmarkedGames', auth.allowCors(gamePublic.getBookmarkedGames))
router.post('/addReview', auth.allowCors(gamePublic.addReview))
router.post('/deleteReview', auth.allowCors(gamePublic.deleteReview))
router.post('/getGameReviews', auth.allowCors(gamePublic.getGameReviews))
router.post('/getCollections', auth.allowCors(gamePublic.getCollections))
router.post('/createCollection', auth.allowCors(gamePublic.createCollection))
router.post('/deleteCollection', auth.allowCors(gamePublic.deleteCollection))
router.post('/toggleGameInCollection', auth.allowCors(gamePublic.toggleGameInCollection))
router.post('/getCollectionGames', auth.allowCors(gamePublic.getCollectionGames))
...
router.post('/bulkUpdate', auth.authenticateToken, auth.userRequired, auth.allowCors(game.bulkUpdateGames))
router.post('/analytics', auth.authenticateToken, auth.userRequired, auth.allowCors(game.getGameAnalytics))
...
router.get('/:id', auth.authenticateToken, auth.userRequired, auth.allowCors(game.getGameById))
